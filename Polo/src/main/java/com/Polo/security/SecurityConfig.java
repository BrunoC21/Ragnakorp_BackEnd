...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/user/login", "/user/create", "/user/search", "/user/search/rut/**", "/user/assignRole/**", "/project/create/**", "/news/create/**", "/project/search", "/user/sessionInfo", "/news/search", "/news/create", "/environmentVinculation/create", "/environmentVinculation/search", "/news/update", "/environmentVinculation/update", "/project/create", "/postulation/create", "/suscriptor/unsubscribe", "/suscriptor/create", "/postulation/search", "/postulation/update", "/userProj/myproj").permitAll() // Permitir acceso sin autenticación
